...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:1yY/RQWNSBjJe2GDCIYoLmpWVidrooriUr4QS/zaATQ=",
        version = "v0.0.0-20190829144645-6f07a24e8650",
    )
    go_repository(
        name = "com_github_hhrutter_tiff",
        importpath = "github.com/hhrutter/tiff",
        sum = "h1:o1wMw7uTNyA58IlEdDpxIrtFHTgnvYzA8sCQz8luv94=",
        version = "v0.0.0-20190829141212-736cae8d0bc7",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:9KI9JpkbCm0b/xSjvNyg9O7G27t+cf+L3um6xv1IbNs=",
        version = "v0.0.0-20210621053716-e28cb8259002",
    )
    ...
    go_repository(
        ...
        sum = "h1:VFon2Yo1PJt+sA57vPAeXWGLSZ7Ux3Jl4h02M0+s3dg=",
        version = "v0.3.13",
    )
    go_repository(
